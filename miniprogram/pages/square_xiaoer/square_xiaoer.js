...
searchtap:function(e){
    console.log("search")
    wx.navigateTo({
    url: '/pages/search_wall_waiter/search_wall_waiter',
  })
  },
  like(e){
    var that=this
  ...
  success: function (res) {
    ...
    db.collection('Wall_waiter').doc(e.currentTarget.dataset.wall_id)
    .update({
      // 想要更新后的数据
      data: {
...
//发送评论
 ...
 navigateToDetail:function(event){
  ...
  onLoad: function(options) {
    var that = this
    const db = wx.cloud.database()
    db.collection('Wall_waiter').orderBy('timestamp', 'desc').get({
      success: function(res) {
        // res.data 包含该记录的数据   
        console.log(res)
        console.log(res.data)
