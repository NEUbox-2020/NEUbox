...
Page({
  ...
  resetBtnClick:function(e){
    ...
    /*const _ = db.command;
    db.collection('Users').doc('app.globalData.open_id').update({
    data:{
        //dislike:_.unshift('dishName')
        //name:this.new_name,//new_name的前面必须加上this才行
        //personal_signature:_.unshift(this.new_personal_signature),
        //department:_.unshift(this.new_department),
        //identity:_.unshift(this.new_identity),
        age:this.new_age,
        
        //password:_.unshift(this.new_password)
